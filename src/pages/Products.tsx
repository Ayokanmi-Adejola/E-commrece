...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Fresh banana ice cream with chunks of real bananas for a refreshing summer treat.",
    price: 0,
  ...
  },
  {
    ...
    description: "Fresh chocolate ice cream with chunks of real chocolate for a refreshing summer treat.",
    price: 0,
  ...
  },
  {
    ...
    description: "Smooth vanilla ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  },
  {
    ...
    description: "strawberry ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  },
  {
    ...
    description: "banana ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  },
  {
    ...
    description: "chocolate ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  {
    id: 9,
    name: "Fanice Vannila 450ml",
    description: "vanilla ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  },
  {
    ...
    description: "cookies & cream ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  },
  {
    ...
    description: "peanut & butter ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  },
  {
    ...
    description: "salted caramel ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
  ...
  },
  {
    ...
    description: "chocolate almond ice cream with ribbons of handcrafted salted caramel throughout.",
    price: 0,
    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <section className="container-custom">
          ...
          >
            <span className="inline-block px-3 py-1 bg-mint text-primary text-sm font-medium rounded-full mb-4">
              All Products
            </span>
            <h1 className="headline mb-6">Available Products</h1>
