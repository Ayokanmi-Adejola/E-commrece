      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-white/10">
          <div>
            ...
            Are you looking for a reliable way to get Fanice products? We've got you covered! We deliver a wide variety of Fanice products throughout Nigeria. From classic favorites to new delights, we bring the frozen goodness directly to your doorstep.
            </p>
